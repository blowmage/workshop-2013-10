...
class PostsControllerNonmemberTest < ActionController::TestCase
  tests PostsController

  setup do
    # User is not a Member
    login_with users :zach
  ...
  test "should get new" do
    ...
    # Redirected because they are not a member
    assert_redirected_to group_day_posts_path(@group, @day)
  end

  test "should create post" do
    # Post not created because user is not a member of the group
